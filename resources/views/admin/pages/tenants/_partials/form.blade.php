...
<div class="form-group">
    <label>Data Assinatura (inicio):</label>
    <input type="date" name="subscription" class="form-control" placeholder="Data Assinatura (inicio):" value="{{ $tenant->subscription ?? old('subscription') }}">
</div>
...
<div class="form-group">
    ...
    <select name="subscription_active" class="form-control">
        <option value="1" @if(isset($tenant) && $tenant->subscription_active == 'Y') selected @endif >SIM</option>
        <option value="0" @if(isset($tenant) && $tenant->subscription_active == 'N') selected @endif >NÃO</option>
    </select>
</div>
...
<div class="form-group">
    ...
    <select name="subscription_suspended" class="form-control">
        <option value="1" @if(isset($tenant) && $tenant->subscription_suspended == 'Y') selected @endif >SIM</option>
        <option value="0" @if(isset($tenant) && $tenant->subscription_suspended == 'N') selected @endif >NÃO</option>
    </select>
</div>
